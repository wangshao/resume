...
\begin{itemize}[parsep=0.5ex]
  ...
  \item \textbf{数据集成}: CDC / Connector Framework / Runtime / 数据同步 / 数据一致性
  \item \textbf{大数据组件}: Apache Flink / Spark / SeaTunnel · Kafka · Iceberg · StarRocks · HDFS · Kyuubi
  \item \textbf{后端与网络}: Vert.x / Netty / Spring Boot
  \item \textbf{稳定性与可观测性}: Metrics / Alert / 自动重连 / 错误数据 dump / 任务重试
