...
\newcommand{\datedsubsection}[2]{%
  \vspace{4pt}\noindent #1\hfill\textit{#2}\par\vspace{1pt}%
}
...
\datedsubsection{\textbf{马上消费金融股份有限公司} · 北京}{2025年10月 -- 2026年3月}
...
\datedsubsection{\textbf{北京逐风科技有限公司} · 北京}{2016年4月 -- 2025年9月}
\role{首席工程师}{Java · Kotlin · Vert.x · Netty · Kafka · Flink · Oracle Redo Log · Connector Runtime}
\begin{onehalfzspacing}
独立负责高性能 Oracle 增量数据采集代理从 0 到 1 的设计实现与长期运维（\url{https://datapipelineinc.github.io/dp-oracle-agent/}）；主导从 0 到 1 搭建数据融合平台核心架构（\url{https://datapipeline.com}）。
\begin{itemize}
...
\begin{itemize}[parsep=0.5ex]
  \item \textbf{编程语言}: Java · Kotlin（精通）· Go · Python（了解）
  ...
  \item \textbf{数据库}: MySQL · Oracle · TiDB · PostgreSQL
\end{itemize}
